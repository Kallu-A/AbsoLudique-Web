    ...
    return (
        <>
            <div className="inset-backdrop-not-nav overflow-y-auto backdrop">
                <div className='centered-element padding-35-60-0 shadow-el rounded-0p75 bg-white'>
                    ...
                    <div className=' padding-1 text-center'>
                        ...
                        <div className='margin-top-35 button-smaller padding-20 button-style center-button'>
                    ...
                    <div className="mt-4 mb-2 text-center">
                        Réalisé par <b><a className="link-color" href="https://github.com/Kallu-A">Kallu</a></b>
                    </div>
                </div>
            </div>
        </>
